...
$$
\boldsymbol s(\boldsymbol \beta) = \frac{\partial l(\boldsymbol \beta)}{\partial \boldsymbol\beta} = \sum_{i=1}^n y_i x_i - n_i \frac{x_i \exp{\mathbf{x}_i^T \boldsymbol \beta}}{1 + \exp{\mathbf{x}_i^T \boldsymbol \beta}}.
$$
