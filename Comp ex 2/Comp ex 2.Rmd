...
```{r, echo = F, eval = T}
ranking = data.frame(
  Team = c("Rosenborg", "Molde", "Lillestroem", "Odd", "Haugesund", "Sandefjord_Fotball", "Ranheim_TF", "Brann", "BodoeGlimt", "Stabaek", "Tromsoe", "Start", "Vaalerenga", "Kristiansund", "Stroemsgodset", "Sarpsborg08"), 
  Played = rep(0,16),
  Won = rep(0,16),
  Drawn = rep(0,16),
  Lost = rep(0,16),
...
colnames(X) = c("Intercept", "HomeAdvantage", "Rosenborg", "Molde", "Lillestroem", "Odd", "Haugesund", "Sandefjord_Fotball", "Ranheim_TF", "Brann", "BodoeGlimt", "Stabaek", "Tromsoe", "Start", "Vaalerenga", "Kristiansund", "Stroemsgodset", "Sarpsborg08")
