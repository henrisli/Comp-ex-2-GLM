...
```
While there is no clear structure, it is difficult to interpret if the model assumptions are sufficiently satisfied. We see  For several covariate patterns we have a relatively small amount of observations. 
